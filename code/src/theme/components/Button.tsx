...
export default (variables = variable) => {
	...
	const buttonTheme = {
		...
		flexDirection: "row",
		elevation: 2,
		color: platformStyle === "material" ? "#000" : undefined,
		offset: platformStyle === "material" ? { width: 0, height: 2 } : undefined,
		opacity: platformStyle === "material" ? 0.2 : undefined,
		radius: platformStyle === "material" ? 1.2 : undefined,
		alignItems: "center",
