...
class MyForm extends Component<Props, any> {
  ...
  _focusNextField(index) {
    ...
    if (index < fields.length - 1) {
      const ref = this.refs[fields[index + 1].name] as any;
...
export const FormComponent = reduxForm<Props, any>({ form: "Form" })(translate("common")(MyForm));
