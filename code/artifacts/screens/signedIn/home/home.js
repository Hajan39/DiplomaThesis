...
import { Text, Header, Container, Card, CardItem, Content, Left, Right, Icon, Body, Title, Button, } from "native-base";
...
class Home extends Component {
    ...
    render() {
        ...
        <Content padder>
          ...
          <Card refreshControl={<RefreshControl refreshing={this.state.isLoading} onRefresh={() => {
