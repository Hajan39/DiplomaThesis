...
import { LOGIN_SECOND_FACTOR_RESULT, LOGIN_CLEAR_CREDENTIALS, LOGIN_ERROR, } from "../login/login.reducer.constants";
...
const RouterReducer = (state = initialNavState, action) => {
    switch (action.type) {
        ...
        case LOGIN_SECOND_FACTOR_RESULT:
            return RootNavigator.router.getStateForAction(NavigationActions.navigate({
                routeName: "SignedIn",
            }), state);
